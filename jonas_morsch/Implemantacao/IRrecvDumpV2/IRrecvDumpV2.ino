...
//#define DECODE_SAMSUNG_AC

// ==================== start of TUNEABLE PARAMETERS ====================
// An IR detector/demodulator is connected to GPIO pin 14
const uint8_t kRecvPin = D9;
...
void setup()
{
  ...
  Serial.begin(2000000, SERIAL_8N1, SERIAL_TX_ONLY);
...
void loop()
{
  ...
  if (irrecv.decode(&results))
  {
    ...
    for (int i = 0; i < results.bits / 8; i++)
    {
      ...
      if (results.bits / 8 - 1 != i)
        Serial.print(",");
    }
    Serial.println("};");

    //Serial.println();
    dumpACInfo(&results);  // Display any extra A/C info if
    // Display the basic output of what we found. we have it.
